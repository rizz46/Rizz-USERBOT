...
# ====================== CONSTANT ===============================
INVALID_MEDIA = "```Maaf Rizz Media Tidak Valid.```"
PP_CHANGED = "```Rizz, Foto Profil Anda Telah Berhasil Diubah.```"
PP_TOO_SMOL = "```Gambar Terlalu Kecil Rizz, Mohon Gunakan Yang Lebih Besar.```"
PP_ERROR = "```Kegagalan Terjadi Saat Proses Gambar, Foto Profil Gagal Diubah.```"

BIO_SUCCESS = "```Rizz, Bio Anda Telah Berhasil Diubah.```"

NAME_OK = "```Rizz, Nama Anda Telah Berhasil Diubah.```"
USERNAME_SUCCESS = "```Username Anda Sudah Diubah.```"
USERNAME_TAKEN = "```Mohon Maaf Rizz, Username Itu Sudah Ada Yang Menggunakannya.```"
# ===============================================================
